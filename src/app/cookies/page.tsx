        ...
        <div className="container max-w-3xl">
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                If you have any questions about our use of cookies, please contact us at <a href="mailto:info@infiniteenergy.ie" style={{ color: "#009968" }} className="hover:underline">info@infiniteenergy.ie</a> or call <a href="tel:0599168075" style={{ color: "#009968" }} className="hover:underline">059 916 8075</a>.
              </p>
            </div>
