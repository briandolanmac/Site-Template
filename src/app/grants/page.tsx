...
export const metadata: Metadata = {
  title: "SEAI Grants for Solar Panels | Infinite Energy",
  description: "Get up to €2,100 SEAI grant for solar panels in Ireland. 0% VAT on solar installations. Infinite Energy handles your grant application.",
};
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                As SEAI Registered installers, Infinite Energy handles the entire grant
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  desc: "Infinite Energy manages your full SEAI grant application process",
                  icon: "📋",
                },
                {
